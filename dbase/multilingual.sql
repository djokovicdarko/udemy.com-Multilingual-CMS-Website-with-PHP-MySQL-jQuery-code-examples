...
--
-- Host: localhost
-- Generation Time: Nov 30, 2011 at 02:12 PM
...
--
-- Table structure for table `access_content`
--

CREATE TABLE `access_content` (
  `access` tinyint(1) unsigned NOT NULL,
  `language` tinyint(4) unsigned NOT NULL,
  `label` varchar(100) NOT NULL,
  PRIMARY KEY (`access`,`language`),
  KEY `language` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `access_content`
--

INSERT INTO `access_content` VALUES(1, 1, 'Administrator');
INSERT INTO `access_content` VALUES(1, 2, '管理員');
INSERT INTO `access_content` VALUES(1, 3, 'Administrador');
INSERT INTO `access_content` VALUES(1, 4, 'Administrator');
INSERT INTO `access_content` VALUES(2, 1, 'User');
INSERT INTO `access_content` VALUES(2, 2, '用戶');
INSERT INTO `access_content` VALUES(2, 3, 'Usuario');
INSERT INTO `access_content` VALUES(2, 4, 'Benutzer');
...
INSERT INTO `admins` VALUES(3, 'Test', 'Admin', 'test@xyz.com', '1f3e7eed2e6cedea8ecf9e05a7bf0e139f08cc2e', '1875741566', 1);
...
INSERT INTO `navigation` VALUES(2, 1, 3, 4);
INSERT INTO `navigation` VALUES(4, 1, 5, 3);
...
--
-- Constraints for table `access_content`
--
ALTER TABLE `access_content`
  ADD CONSTRAINT `access_content_ibfk_2` FOREIGN KEY (`language`) REFERENCES `languages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `access_content_ibfk_1` FOREIGN KEY (`access`) REFERENCES `access` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
