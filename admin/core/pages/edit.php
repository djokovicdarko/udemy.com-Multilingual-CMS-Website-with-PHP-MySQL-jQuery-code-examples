	...
	if (!empty($page)) {
		...
		if (isset($_POST['name'])) {
			...
			if (
				...
				$objPage->duplicate($array['identity'], $id)
			) {
...
<h1><?php echo $this->objLanguage->labels[20]; ?></h1>
		...
		<tr>
			<td>
				<input type="text" name="name" id="name" class="field field_long"
					value="<?php echo $objForm->stickyText('name', $page['name']); ?>" />
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td>
				<textarea name="content" id="content" cols="" rows=""
					class="ckEditor"><?php echo $objForm->stickyText('content', $page['content']); ?></textarea>
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td>
				<input type="text" name="meta_title" id="meta_title" class="field field_long"
					value="<?php echo $objForm->stickyText('meta_title', $page['meta_title']); ?>" />
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td>
				<textarea name="meta_description" id="meta_description" 
					cols="" rows=""	class="field area"><?php echo $objForm->stickyText('meta_description', $page['meta_description']); ?></textarea>
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td>
				<textarea name="meta_keywords" id="meta_keywords" 
					cols="" rows=""	class="field area"><?php echo $objForm->stickyText('meta_keywords', $page['meta_keywords']); ?></textarea>
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			<td>
				<input type="text" name="identity" id="identity" class="field field_long"
					value="<?php echo $objForm->stickyText('identity', $page['identity']); ?>" />
			</td>
		</tr>
		<tr>
			<td>
